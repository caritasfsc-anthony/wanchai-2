...
export async function resetDatabase(): Promise<void> {
  await executeSql("DELETE FROM submission_revisions");
  await executeSql("DELETE FROM fieldwork_photos");
  await executeSql("DELETE FROM submissions");
  await executeSql("DELETE FROM students");
