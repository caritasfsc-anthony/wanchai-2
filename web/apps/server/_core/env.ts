...
export const env = {
  ...
  // Optional: Google Apps Script Web App URL for streaming fieldwork submissions to Google Sheets.
  // Add GOOGLE_SHEET_WEBHOOK_URL in the project environment settings panel.
  // See GOOGLE_APPS_SCRIPT.js at project root for full setup instructions.
  GOOGLE_SHEET_WEBHOOK_URL: readEnv(process.env.GOOGLE_SHEET_WEBHOOK_URL) ?? ""
};
